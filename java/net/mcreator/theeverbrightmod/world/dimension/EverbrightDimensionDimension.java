...
package net.mcreator.theeverbrightmod.world.dimension;
...
public class EverbrightDimensionDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("the_everbright_mod:everbright_dimension"), customEffect);
		}
	}
}
